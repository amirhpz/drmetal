<x-layouts.app :meta-title="$metaTitle" :meta-description="$metaDescription">
    <section class="inner-hero section">
        <div class="container inner-hero-grid about-visual-hero">
            <div>
                <h1>درباره {{ $settings['company.name'] ?? 'دکتر متالینیوم' }}</h1>
    ...
    <section class="section tight-section">
        <div class="container factory-panel">
            <div>
                ...
                <p>کارخانه دکتر متالینیوم مجهز به خطوط تولید پیشرفته، سیستم‌های کنترلی و آزمایشگاه تخصصی کنترل کیفیت است. این بخش برای تصاویر واقعی کارخانه در آینده آماده شده است.</p>
