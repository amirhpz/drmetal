...
Route::middleware(['auth', 'panel'])
    ...
    ->group(function (): void {
        ...
        Route::resource('post-categories', PanelPostCategoryController::class)->except('show');
        Route::resource('posts', PanelPostController::class)->except('show');
        Route::resource('clients', PanelClientController::class)->except('show');
        Route::resource('quote-requests', PanelQuoteRequestController::class)->only(['index', 'show', 'update', 'destroy']);
        ...
        Route::get('settings', [PanelSiteSettingController::class, 'edit'])->name('settings.edit');
        Route::put('settings', [PanelSiteSettingController::class, 'update'])->name('settings.update');
    });
