...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'company.name_en', 'value' => 'Dr Metal Metallurgical Industries', 'group' => 'company', 'type' => 'text'],
            ['key' => 'company.legal_name', 'value' => 'شرکت برتر فناوران راکا', 'group' => 'company', 'type' => 'text'],
            ['key' => 'company.tagline', 'value' => 'پرتوی فناوری و دانش', 'group' => 'company', 'type' => 'text'],
            ['key' => 'company.tagline_en', 'value' => 'The Ray of Technology and Science', 'group' => 'company', 'type' => 'text'],
            ['key' => 'company.website', 'value' => 'www.drmetalco.ir', 'group' => 'company', 'type' => 'text'],
            ...
            ['key' => 'social.instagram', 'value' => '', 'group' => 'social', 'type' => 'text'],
            ['key' => 'social.linkedin', 'value' => '', 'group' => 'social', 'type' => 'text'],
